...
namespace Voltstrap.Extensions
{
    static class BootstrapperIconEx
    {
        public static IReadOnlyCollection<BootstrapperIcon> Selections => new BootstrapperIcon[]
        {
            ...
            BootstrapperIcon.IconVoltstrapClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconVoltstrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconVoltstrap => Properties.Resources.IconVoltstrap,
                ...
                BootstrapperIcon.IconVoltstrapClassic => Properties.Resources.IconVoltstrapClassic,
                _ => Properties.Resources.IconVoltstrap
            };
        }
    }
}
