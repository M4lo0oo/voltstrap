...
using Voltstrap.Models.APIs;
using CommunityToolkit.Mvvm.Input;

namespace Voltstrap.Models.Entities
{
    public class ActivityData
    {
        ...
        // everything below here is optional strictly for voltstraprpc, discord rich presence, or game history
