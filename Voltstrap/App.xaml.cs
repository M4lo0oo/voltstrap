...
namespace Voltstrap
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "Voltstrap-QA";
#else
        public const string ProjectName = "Voltstrap";
#endif
        public const string ProjectOwner = "Voltstrap";
        public const string ProjectRepository = "voltstraplabs/voltstrap";
        public const string ProjectDownloadLink = "https://voltstraplabs.com";
        public const string ProjectHelpLink = "https://voltstraplabs.com/wiki/help/";
        public const string ProjectSupportLink = "https://github.com/voltstraplabs/voltstrap/issues/new";
        ...
        public static string WebUrl
        {
            get {
                ...
                string url = ConstructVoltstrapWebUrl();
        ...
        public static string ConstructVoltstrapWebUrl()
        {
            ...
            if (Settings.Prop.WebEnvironment == WebEnvironment.Production || !Settings.Prop.DeveloperMode)
                return "services.voltstraplabs.com";

            string? sub = Settings.Prop.WebEnvironment.GetDescription();
            return $"services-{sub}.voltstraplabs.com";
        }
