...
using Voltstrap.RobloxInterfaces;
using Voltstrap.UI.Elements.Bootstrapper.Base;
...
namespace Voltstrap
{
    public class Bootstrapper
    {
        ...
        public string BackgroundUpdaterMutexName => $"Voltstrap-BackgroundUpdater-{_launchMode}";

        public string MutexNamePrefix { get; set; } = "Voltstrap-Bootstrapper";
        ...
        private async Task<bool> CheckForUpdates()
        {
            ...
            {
                App.Logger.WriteLine(LOG_IDENT, $"More than one Voltstrap instance running, aborting update check");
                return false;
            }
            ...
            SetStatus(Strings.Bootstrapper_Status_UpgradingVoltstrap);

            try
            {
#if DEBUG_UPDATER
                string downloadLocation = Path.Combine(Paths.TempUpdates, "Voltstrap.exe");
                ...
                catch (Exception ex)
                {
                    ...
                    if (ex.GetType() == typeof(ChecksumFailedException))
                    {
                        ...
                        Frontend.ShowConnectivityDialog(
                            ...
                            String.Format(Strings.Dialog_Connectivity_UnableToDownloadReason, "[https://voltstraplabs.com/wiki/help/voltstrap-cannot-download-roblox/](https://voltstraplabs.com/wiki/help/voltstrap-cannot-download-roblox/)"),
